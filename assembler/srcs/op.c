...
/*   Updated: 2018/07/01 14:18:06 by clrichar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (index_ope == 0 || index_ope == 1 || index_ope == 5
			|| index_ope == 6 || index_ope == 7 || index_ope == 12)
		return (4);
	else if (index_ope == 8 || index_ope == 9 || index_ope == 10
			|| index_ope == 11 || index_ope == 13 || index_ope == 14)
		return (2);
	return (0);
}
...
{
	if (letter == DIRECT_CHAR)
		return (dir);
	if (letter == 'r')
		return (reg);
	if ((letter >= '0' && letter <= '9') || letter == '-')
		return (indir);
	if (letter == LABEL_CHAR)
		return (label);
	return (none);
}
